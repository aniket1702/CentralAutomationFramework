...
public class StringToUrlTypeConverter implements Converter<URL> {
     ...
     * The converter is instantiated for every call, so it shouldn't have any internal state.
     *
     * @param method the method invoked on the <code>{@link com.caf.automation.config.IConfigurator} object</code>
     * @param url    the property value specified as input text to be converted to the T return type
